...
// 1. Part of Projection
Shader "FluidSim/Divergence1" 
{
	SubShader 
	{
    	Pass 
    	{
			...
			uniform float _HalfInverseCellSize; // 0,5 / CellSize // = /Distance
			...
			float4 frag(v2f IN) : COLOR
			{
			    ...
			    return float4(result,0,0,1); // divergence is a scalar field -> only x
			}
