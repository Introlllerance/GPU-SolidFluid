...
//2nd part of Projection
Shader "FluidSim/SubtractGradient1" 
{
	SubShader 
	{
    	Pass 
    	{
			...
			float4 frag(v2f IN) : COLOR
			{
			    ...
			    float2 newV = oldV - grad; // subtract the gradient 
				// why take average of grad 
			    
			    return float4(newV,0,1);  //2d vector field
			}
